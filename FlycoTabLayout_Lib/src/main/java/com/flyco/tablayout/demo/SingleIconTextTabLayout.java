 ...
 * 文字切换 TabLayout
 */
public class SingleIconTextTabLayout extends FrameLayout implements View.OnClickListener {
     ...
     * 文字选中颜色
     */
    private int mTextSelectColor = Color.parseColor("#2C97DE");

    /**
     * 文字未选中颜色
     */
    private int mTextUnselectColor = Color.parseColor("#66000000");
    ...
    public SingleIconTextTabLayout(Context context) {
        this(context, null, 0);
    }

    public SingleIconTextTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SingleIconTextTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.layout_text_icon_tab, null);
            tabView.setTag(i);
            addTab(i, tabView);
        }
    }
